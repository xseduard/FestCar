...
@section('content')
    <section class="content-header">
        ...
        <h1 class="pull-right">
           <a class="btn btn-primary btn-flat pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{!! route('recibos.create') !!}"><i class="fa fa-plus"></i> &nbsp; Aregar</a>
        </h1>
    </section>
    <div class="content">
                ...
                <div class="box-body table-responsive">
                    @if($recibos->isEmpty())
                        <div class="alert alert-info alert-dismissible">
                           ...
                           No se encontraron registros de Recibos en esta consulta.
                      </div>                    
                    @else
                        @include('recibos.table')
                    @endif
                    @include('common.paginate', ['records' => $recibos])
                </div>
            </div>
        </div>
    </div>
