<table class="table table-responsive table-hover" id="tecnicomecanicas-table">
    ...
    @foreach($tecnicomecanicas as $tecnicomecanica)
        ...
        >
            ...
            <td custom-title="{!! $tecnicomecanica->dias_actual_diferencia !!}/{!! $tecnicomecanica->dias_diferencia !!}">
            ...
            <td>
                @if ($tecnicomecanica->fecha_vigencia_inicio != $tecnicomecanica->fecha_vigencia_final->subYear())                   
                        <span class="badge badge-danger" custom-title="Verfiqué los datos ingresados, {!! $tecnicomecanica->user->fullname !!}"><i class='fa fa fa-exclamation fa-spin fa-fw'></i> Fechas Inconsistentes</span>
                @else
            ...
            <td>
                ...
                <div class='btn-group pull-right'>
                    <!-- 
                        <a href="{!! route('tecnicomecanicas.show', [$tecnicomecanica->id]) !!}" class='btn btn-default btn-xs' custom-title="Ver"><i class="glyphicon glyphicon-eye-open"></i></a>
                    -->
                    <a href="{!! route('tecnicomecanicas.edit', [$tecnicomecanica->id]) !!}" class='btn btn-default btn-xs' custom-title="Editar"><i class="glyphicon glyphicon-edit"></i></a>
