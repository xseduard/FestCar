...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">Revisión Técnico Mecánica (RTM)</h1>
        <h1 class="pull-right">
           <a class="btn btn-primary btn-flat pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{!! route('tecnicomecanicas.create') !!}"><i class="fa fa-plus"></i> &nbsp; Aregar</a>
        </h1>
    </section>
    <div class="content">
        ...
        {!! Form::open(['route' => 'tecnicomecanicas.index', 'method' => 'GET']) !!}  
            @include('common.search_documentos_vehiculo', ['records' => $tecnicomecanicas])
         {!! Form::close() !!}
        ...
        <div class="animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
            <div class="box box-primary">
                <div class="box-body">
                    @if($tecnicomecanicas->isEmpty())
                        <div class="alert alert-info alert-dismissible">
                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                            <h4><i class="icon fa fa-info"></i>Sistema de Información</h4>
                           No se encontraron registros de Tecnicomecanicas en esta consulta.
                      </div>                    
                    @else
                        @include('tecnicomecanicas.table')
                    @endif
                    @include('common.paginate', ['records' => $tecnicomecanicas])
                </div>
            </div>
        </div>
    </div>
