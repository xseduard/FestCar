...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">Poliza Responsabilidads</h1>
        <h1 class="pull-right">
           <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{!! route('polizaResponsabilidads.create') !!}"><i class="fa fa-plus"></i> &nbsp; Aregar</a>
        </h1>
    </section>
    <div class="content">
                ...
                <div class="box-body">
                    @if($polizaResponsabilidads->isEmpty())
                        <div class="alert alert-info alert-dismissible">
                           ...
                           No se encontraron registros de PolizaResponsabilidads en esta consulta.
                      </div>                    
                    @else
