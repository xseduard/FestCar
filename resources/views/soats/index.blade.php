...
@section('content')
    ...
    <div class="content">
        ...
        <div class="animsition" data-animsition-in-class="zoom-in-sm" data-animsition-in-duration="1500" data-animsition-out-class="zoom-out-sm" data-animsition-out-duration="800">
         ...
         {!! Form::open(['route' => 'soats.index', 'method' => 'GET']) !!}  
            @include('common.search_documentos_vehiculo', ['records' => $soats])
         {!! Form::close() !!}
        <div class="clearfix"></div>
                ...
                <div class="box-body">
                    @if($soats->isEmpty())
                        <div class="alert alert-info alert-dismissible">
                           ...
                           No se encontraron registros de Soat en esta consulta.
                      </div>                    
                    @else
                        @include('soats.table')
                    @endif
                    @include('common.paginate', ['records' => $soats])
                </div>
            </div>
        </div>
    </div>
