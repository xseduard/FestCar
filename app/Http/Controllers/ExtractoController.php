...
class ExtractoController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $extractos = Extracto::with(['vehiculo', 'user', 'cps.juridico', 'cps.natural', 'conductoruno.natural'])->orderBy('updated_at', 'desc')->paginate(15);
    ...
    public function create()
    {
        ...
        if (empty($selectores['ContratoPrestacionServicio_id'])) {
            Flash::error('No Existen contratos de prestación de servicios Vigentes');           
